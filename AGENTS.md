...
- Verify Ask AI and image editing with `cargo test --test ask_ai`, which drives full requests against `src/bin/stub_agent.rs`. Extend that suite instead of testing agent behavior by hand.
